...
static inline void op_invalid(Chip8 *c8, uint16_t op) {
...
static inline void op_0xxx(Chip8 *c8, uint16_t op) {
...
static inline void op_8xxx(Chip8 *c8, uint16_t op) { table8[op & 0xF](c8, op); }
...
static inline void op_fxxx(Chip8 *c8, uint16_t o) { tableF[o & 0xFF](c8, o); }
